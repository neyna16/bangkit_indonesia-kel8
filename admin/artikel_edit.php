...
<form action="proses_artikel_edit.php"
method="POST" enctype="multipart/form-data">
<div class="form-group">
<input type="hidden" name="id_artikel"
class="form-control" value="<?= $row['id_artikel'] ?>">
<div class="form-group">
<label for="">Judul</label>
<input type="text" name="judul"
class="form-control" id="judul" value="<?= $row['judul'] ?>">
</div>
<div class="form-group">
<label for="">Isi Artikel</label>
<textarea rows="15" cols="100"
name="artikel" class="ckeditor" class="form-control"
id="artikel"><?= $row['artikel'] ?></textarea>
</div>
<div class="form-group">
<label for="">Tanggal</label>
<input type="date" name="tanggal"
class="form-control" id="tanggal" value="<?= $row['tanggal'] 
?>">
</div>
<div class="form-group">
